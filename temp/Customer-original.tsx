...
function Customer({ contractAddress }: CustomerProps) {
    ...
    const renderContent = () => {
        ...
        return (
            <div className="customer-wrapper" style={{
                background: "#0A0B0E",
                minHeight: "100vh",
                position: "relative"
            }}>
                <div className="customer-inner" style={{
                    padding: "1.5rem"
                }}>
                    {/* Header Bar */}
                    <Flex
                        ...
                        <HStack>
                            ...
                            >
                                {tradingPair.includes("BTC") ? (
                                    <Icon as={SiBitcoinsv} boxSize="50px" color="#FEDF56" />
                                ) : tradingPair.includes("ETH") ? (
                                    <Icon as={FaEthereum} boxSize="50px" color="#FEDF56" />
                                ) : (
                                    <Icon as={GoInfinity} boxSize="50px" color="#FEDF56" />
                                )}
                            </Box>
                    ...
                    <Flex direction={{ base: 'column', md: 'row' }} gap={6}>
                        ...
                        <Box width={{ base: '100%', md: '80%' }} pr={{ base: 0, md: 4 }} ml={4}>
                            <Tabs variant="line" colorScheme="yellow" border="1px solid" borderColor="rgba(255, 255, 255, 0.05)" borderRadius="xl" pb={2}>
                                <Box pb={1}>
                                    <TabList
                                            ...
                                            >
                                                ...
                                                <Flex direction={{ base: 'column', md: 'row' }} gap={6}>
                                                    ...
                                                    <Box width={{ base: '100%', md: '80%' }} pr={{ base: 0, md: 4 }} ml={4}>
                                                        ...
                                                        {/* Rules Section */}
                                                        <Box mt={8} border="1px solid rgba(255, 255, 255, 0.05)" borderRadius="xl" p={4}>
                                                            <Flex justify="space-between" align="center" onClick={() => setShowRules(!showRules)} cursor="pointer">
                                                                <Heading size="md" color="#FEDF56" fontSize="25px">Rules</Heading>
                                                                <Icon as={showRules ? ChevronUpIcon : ChevronDownIcon} color="#FEDF56" boxSize="30px" />
                                                            </Flex>
                                                            {showRules && (
                                                                <Box mt={4}>
                                                    ...
                                                    <Box width={{ base: "100%", md: "25%" }} mt={{ base: 4, md: 0 }} ml={{ base: 0, md: 4 }}>
                                                        ...
                                                        >
                                                            ...
                                                            {(currentPhase === Phase.Maturity || currentPhase === Phase.Expiry) && (
                                                                <Flex justify="space-between" align="center" mt={2} textAlign="center" fontSize="20px" color="#FEDF56">
                                                                    ...
                                                                    <Text fontWeight="bold" color="#FEDF56">{finalPrice} USD</Text>
                                                                </Flex>
                                                            )}
                                                        ...
                                                        >
                                                            ...
                                                            <Text textAlign="center" fontSize="md" mb={4} color="#FEDF56">You're betting</Text>

                                                            <HStack spacing={4} mb={3} mx={2}>
                                                                <Button
                                                                    borderRadius="md"
                                                                    bg="#0A0B0E"
                                                                    border="1px solid"
                                                                    ...
                                                                    leftIcon={<FaArrowUp color="#56ff56" />}
                                                                    color="#56ff56"
                                                                    isDisabled={currentPhase !== Phase.Bidding}
                                                                    _hover={{
                                                                        bg: "rgba(86, 255, 86, 0.1)",
                                                                    }}
                                                                ...
                                                                <Button
                                                                    ...
                                                                    leftIcon={<FaArrowDown color="#FF6B81" />}
                                                                    color="#FF6B81"
                                                                    isDisabled={currentPhase !== Phase.Bidding}
                                                                    _hover={{
                                                            ...
                                                            <FormControl mb={2} mt={6} color="white">
                                                                <FormLabel color="#FEDF56">You're betting</FormLabel>
                                                                <Input
                                                            ...
                                                            <HStack spacing={2} mt={1} mb={2} mx={2} alignItems="center" justifyContent="center">
                                                                <Button
                                                                    bg="#0052FF"
                                                                    color="white"
                                                                    _hover={{ bg: "#0040C1" }}
                                                        ...
                                                        <Box
                                                            ...
                                                            borderColor="rgba(255, 255, 255, 0.05)"
                                                        >
                                                            <Text fontSize="md" fontWeight="bold" color="#FEDF56" mb={3}>My Holdings</Text>
                                                            <Button
                                                                variant="outline"
                                                                size="sm"
                                                                width="100%"
                                                                rightIcon={<FaArrowDown color="#FEDF56" />}
                                                                bg="#0A0B0E"
                                                                color="#FEDF56"
                                                                borderColor="#FEDF56"
                                                                _hover={{ bg: "rgba(254, 223, 86, 0.1)" }}
                                                        ...
                                                        <Box
                                                            ...
                                                            mb={4}
                                                        >
                                                            <Text fontSize="2xl" fontWeight="bold" mb={4} mt={2} color="#FEDF56" textAlign="center">
                                                                Market is Live
                                                            </Text>
                                                            ...
                                                            >
                                                                <VStack align="stretch" spacing={3} position="relative">
                                                                    ...
                                                                    {/* Trading Phase */}
                                                                    <HStack spacing={4}>
                                                                        <Circle size="35px" bg={currentPhase >= Phase.Bidding ? "#FEDF56" : "#0A0B0E"} color="black" zIndex={1} fontWeight="bold" borderWidth={1} borderColor="#FEDF56">
                                                                            {currentPhase >= Phase.Bidding ? <CheckIcon boxSize={4} /> : '1'}
                                                                        </Circle>
                                                                        <VStack align="start" spacing={0} fontWeight="bold">
                                                                            <Text fontSize="lg" color={currentPhase === Phase.Trading ? "#FEDF56" : "gray.500"}>
                                                                                Trading
                                                                            </Text>
                                                                        ...
                                                                        {currentPhase === Phase.Trading && (
                                                                            <Button
                                                                                ...
                                                                                color="#FEDF56"
                                                                                size="sm"
                                                                                leftIcon={<FaChartLine color="#FEDF56" />}
                                                                                onClick={() => {
                                                                                    if (marketService) {
                                                                    ...
                                                                    {/* Bidding Phase */}
                                                                    <HStack spacing={4}>
                                                                        <Circle size="35px" bg={currentPhase >= Phase.Maturity ? "#FEDF56" : "#0A0B0E"} color="black" zIndex={1} fontWeight="bold" borderWidth={1} borderColor="#FEDF56">
                                                                            {currentPhase >= Phase.Maturity ? <CheckIcon boxSize={4} /> : '2'}
                                                                        </Circle>
                                                                        <VStack align="start" spacing={0} fontWeight="bold">
                                                                            <Text fontSize="lg" color={currentPhase === Phase.Bidding ? "#FEDF56" : "gray.500"}>
                                                                                Bidding
                                                                            </Text>
                                                                            <Text fontSize="xs" color="gray.500">
                                                                    ...
                                                                    {/* Maturity Phase */}
                                                                    <HStack spacing={4}>
                                                                        <Circle size="35px" bg={currentPhase >= Phase.Expiry ? "#FEDF56" : "#0A0B0E"} color="black" zIndex={1} fontWeight="bold" borderWidth={1} borderColor="#FEDF56">
                                                                            {currentPhase >= Phase.Expiry ? <CheckIcon boxSize={4} /> : '3'}
                                                                        </Circle>
                                                                        <VStack align="start" spacing={0} fontWeight="bold">
                                                                            <Text fontSize="lg" color={currentPhase === Phase.Maturity ? "#FEDF56" : "gray.500"}>
                                                                                Maturity
                                                                            </Text>
                                                                            <Text fontSize="xs" color="gray.500">
                                                                    ...
                                                                    <HStack spacing={4}>
                                                                        <Circle size="35px" bg={currentPhase === Phase.Expiry ? "#FEDF56" : "#0A0B0E"} color="black" zIndex={1} fontWeight="bold" borderWidth={1} borderColor="#FEDF56">
                                                                            {currentPhase === Phase.Expiry ? <CheckIcon boxSize={4} /> : '4'}
                                                                        </Circle>
                                                                        <VStack align="start" spacing={0} fontWeight="bold">
                                                                            <Text fontSize="lg" color={currentPhase === Phase.Expiry ? "#FEDF56" : "gray.500"}>
                                                                                Expiry
                                                                            </Text>
                                                                            <Text fontSize="xs" color="gray.500">
    ...
    }
                                            {
                                                showResult && (
                                                    <Box
                                                        ...
                                                        bg={resultMessage === "YOU WIN" ? "rgba(86, 255, 86, 0.2)" : "rgba(255, 107, 129, 0.2)"}
                                                        color={resultMessage === "YOU WIN" ? "#56ff56" : "#FF6B81"}
                                                        px={6}
                                                        py={3}
                                                        borderRadius="md"
                                                        boxShadow="lg"
                                                        border="1px solid"
                                                        borderColor={resultMessage === "YOU WIN" ? "#56ff56" : "#FF6B81"}
                                                    >
                                                        {resultMessage}
                                                    </Box>
                                                )
